...
Using the checkboxes , you can select which types of measurement data you want to analyze (PUI, ACF, optische Spektren, Rf Spektren). Press the **"Auswertung Starten"** button to start the analysis.
